...
export default function CategoriesPage() {
  ...
  const categories = [
    ...
    {
      images: [
        {img: "https://m.media-amazon.com/images/I/61BZm7qbkyL._AC_UL480_FMwebp_QL65_.jpg", category: "Huggies Complete Comfort Wonder Pants | Pant Style Baby Diapers L Size, 64 Coun", name: "Baby Diapers", price: "₹714", oldPrice: "₹749" },
        {img:"https://m.media-amazon.com/images/I/61OwWTLnhyL._AC_UL480_FMwebp_QL65_.jpg",category: "Huggies Natural Soft Premium Baby Diaper Pants, Our No.1 Soft Pants, Large (L) ", name: "Premium Baby Diaper", price: "₹591", oldPrice: "₹599" },
        {img:"https://m.media-amazon.com/images/I/81TZ5VXMOAL._AC_UL480_FMwebp_QL65_.jpg",category: "MamyPoko Pants Extra Absorb Baby Diapers, Medium (M size)", name: "Absorb Baby Diapers", price: "₹1559", oldPrice: "₹1599" },
        {img: "https://m.media-amazon.com/images/I/71ePuafgbmL._AC_UL480_FMwebp_QL65_.jpg",category: "Pampers Premium Care Pant Style Baby Diapers | Medium (M size)", name: "Baby Diapers", price: "₹1933", oldPrice: "₹1999" },
        {img:"https://m.media-amazon.com/images/I/81opk3yvV8L._AC_UL480_FMwebp_QL65_.jpg",category: "Himalaya Total Care Baby Pants Diapers, Extra Large (12 - 17 kg), 74 Count", name: "Himalaya", price: "₹938", oldPrice: "₹999" },
        {img:"https://m.media-amazon.com/images/I/618vKle+A5L._AC_UL480_FMwebp_QL65_.jpg",category: "Pampers Premium Care Pant Style Baby Diapers, Newborn/X-Small (NB/XS), 7", name: "Newborn", price: "₹746", oldPrice: "₹749" },
        {img:"https://m.media-amazon.com/images/I/711gPkYu2gL._AC_UL480_FMwebp_QL65_.jpg",category: "Pampers Premium Care Pant Style Baby Diapers | Small (S size) | 140 Count", name: "Diapers", price: "₹2019", oldPrice: "₹2049" },
        {img:"https://m.media-amazon.com/images/I/71iLJDssIDL._AC_UL480_FMwebp_QL65_.jpg",category: "Pampers Premium Care Pant Style Baby Diapers, XX-Large (XXL size), 90 Count,", name: "Diapers", price: "₹2971", oldPrice: "₹2999" },
        {img:"https://m.media-amazon.com/images/I/71NqsRJuzhL._AC_UL480_FMwebp_QL65_.jpg",category: "Pampers Active Baby Diapers, New Born, Extra Small, (NB, XS) size, 24 Count, Taped style", name: "Diapers", price: "₹315", oldPrice: "₹349" },
        {img:"https://m.media-amazon.com/images/I/61oubCHqllL._AC_UL480_FMwebp_QL65_.jpg",category: "Pampers Premium Care Pant Style Baby Diapers, Newborn (XS), 30 Count,", name: "Newborn", price: "₹399", oldPrice: "₹449" },
        {img:"https://m.media-amazon.com/images/I/61JaCJ4w1dL._AC_UL480_FMwebp_QL65_.jpg",category: "Pampers Active Baby Taped Diapers, Small size diapers, (S) 92 count, ", name: " Taped Diapers", price: "₹1338", oldPrice: "₹1349" },
        {img:"https://m.media-amazon.com/images/I/81B2IrEd1nL._AC_UL480_FMwebp_QL65_.jpg",category: "Himalaya Total Care Baby Pants Diapers, Extra Large (12 - 17 kg), 74 Count", name: "Himalaya", price: "₹799", oldPrice: "₹819" },
        {img:"https://m.media-amazon.com/images/I/71lnAtV-97L._AC_UL480_FMwebp_QL65_.jpg",category: " Supples Premium Diaper Pants | for Newborn Babies | 80 Diapers |", name: "Newborn Babies", price: "₹505", oldPrice: "₹225" },
      ],
      link: "Babycare",
    },
    {
      images: [
        {img:"https://m.media-amazon.com/images/I/916aCP2ISiL._AC_UL480_FMwebp_QL65_.jpg",category: "Karachi Fruit Biscuit - Premium, 400 g", name: "Biscuitc", price: "₹171", oldPrice: "₹199" },
        {img:"https://m.media-amazon.com/images/I/71PzQlqCLzL._AC_UL480_FMwebp_QL65_.jpg",category: "Karachi Bakery Cashew Biscuits, 400g", name: "Biscuit", price: "₹218", oldPrice: "₹249" },
        {img:"https://m.media-amazon.com/images/I/71K-Na2qlZL._AC_UL480_FMwebp_QL65_.jpg",category: "Karachi Bakery Pistachio Biscuits, 400 g/300 g (Weight May Vary)", name: "Biscuit", price: "₹285", oldPrice: "₹299" },
        {img:"https://m.media-amazon.com/images/I/81D0zhsOSIL._AC_UL480_FMwebp_QL65_.jpg",category: "Karachi Bakery Almond Millet Biscuits, 300 g", name: "Biscuit", price: "₹145", oldPrice: "₹149" },
        {img:"https://m.media-amazon.com/images/I/71LsS6mowpL._AC_UL480_FMwebp_QL65_.jpg",category: "Karachi Bakery Butter Short Bread, 300 g", name: "Butter", price: "₹234", oldPrice: "₹249" },
        {img:"https://m.media-amazon.com/images/I/41rg949C5fL._AC_UL480_FMwebp_QL65_.jpg",category: "Baker's Studio Orange Almond Cookies 200gm - Gluten-Free Healthy Snack | Nutrient-Rich", name: "Snack", price: "₹245", oldPrice: "₹249" },
        {img:"https://m.media-amazon.com/images/I/71Hk1OTsD2L._AC_UL480_FMwebp_QL65_.jpg",category: "Midbreak Pista Delight - Sugar-Free Biscuits | Cookies Infused With Rich Pistachios |", name: "Biscuit", price: "₹356", oldPrice: "₹379" },
        {img:"https://m.media-amazon.com/images/I/816vG6Pci5L._AC_UL480_FMwebp_QL65_.jpg",category: "ANAND Sweets Pure Butter Almond Cookies/Biscotti (225 gram, Pack Of 2), Anand", name: "Biscuit", price: "₹915", oldPrice: "₹999" },
        {img:"https://m.media-amazon.com/images/I/61Gv+Cg7yTL._AC_UL480_FMwebp_QL65_.jpg",category: "CookieMan Butter Cashew Cookies – 300g Tin Box | Rich & Crunchy Eggless Cashew", name: "Butter", price: "₹220", oldPrice: "₹249" },
        {img:"https://m.media-amazon.com/images/I/61smUjpd0vL._AC_UL480_FMwebp_QL65_.jpg",category: "Snack-a-Doodle Butter Cookies | Nutritious Healthy Snacks | No Maida | Rich In", name: "Snacks", price: "₹220", oldPrice: "₹239" },
        {img:"https://m.media-amazon.com/images/I/71K+5uUMMsL._AC_UL480_FMwebp_QL65_.jpg",category: "Karachi Bakery Chai Biscuit, 400g", name: " Biscuit", price: "₹125", oldPrice: "₹139" },
        {img:"https://m.media-amazon.com/images/I/81gDyJWR24L._AC_UL480_FMwebp_QL65_.jpg",category: "Karachi Bakery Coconut Flavour Cookies 400g | Delicious Snack | Tea Time", name: "Snack ", price: "₹150", oldPrice: "₹159" },
        {img:"https://m.media-amazon.com/images/I/91GJdSbg0tL._AC_UL480_FMwebp_QL65_.jpg",category: "Karachi Bakery's Ajwain Biscuits 400g | Delicious Biscuits", name: "Biscuits", price: "₹279", oldPrice: "₹299" },
        {img:"https://m.media-amazon.com/images/I/91GJdSbg0tL._AC_UL480_FMwebp_QL65_.jpg",category: "Karachi Bakery Premium Fruit Biscuit, 500g", name: "Biscuits", price: "₹250", oldPrice: "₹279" },
        {img:"https://m.media-amazon.com/images/I/71DDi4vWygL._AC_UL480_FMwebp_QL65_.jpg",category: "Karachi's Bakery Milk Mysore Pack 200G", name: "Milk", price: "₹110", oldPrice: "₹119" },
        ],
      link: "Bakery",
    },
    {
    ...
    {
      images: [
       {img:"https://m.media-amazon.com/images/I/71tTYGmAMGL._AC_UL480_FMwebp_QL65_.jpg",category: "Coca-Cola Original Taste Soft Drink Can, 300 Ml", name: "referator ac", price: "₹12", oldPrice: "₹38,000"},
       {img:"https://m.media-amazon.com/images/I/41pyEMwnGCL._AC_UL480_FMwebp_QL65_.jpg",category: "Sprite Lemon-Lime Flavoured Cold Drink | Refreshing Taste | Clear Soft Drink with No", name: "referator ac", price: "₹12", oldPrice: "₹38,000" },
       {img:"https://m.media-amazon.com/images/I/61yecBpCDhL._AC_UL480_FMwebp_QL65_.jpg",category: "Thums Up Soft Drink Can, 300 ml", name: "referator ac", price: "₹12", oldPrice: "₹38,000" },
      ],
